...
Tiles: **Codes known** (both exports), **Current range**, **Needs setting**
(current but missing route, unit or tray yield), **Current, no demand** (enabled
but no open job line — the ones to consider switching off).
